! function() {
    var e = function(e) {
        ...
        v = e(function(e, t) {
            ...
            function r() {
                if (a) return a;
                var e = document.querySelector("#shopify-features");
                if (e) try {
                    a = JSON.parse(e.innerText)
                } catch (t) {} else a = {};
                return a
            }
    ...
    e(function(e, t) {
        ...
        var r = c(u),
            ...
            a = c(w),
            i = c(_);
        t.register = p.register, t.resetBetas = h.resetBetas, t.resetRegistry = p.reset, window.Shopify = window.Shopify || {}, (0, p.register)({
            name: "model-viewer",
            version: "0.6",
            hasLegacy: !0,
            ...
            autoLoadSelector: ["video", "model-viewer", 'a[rel="ar"]', 'a[href*="package=com.google.ar.core;action=android.intent.action.VIEW;"]', "[data-shopify-xr]", 'iframe[src^="https://www.youtube.com/embed/"]']
        }), (0, p.register)({
