            ...
            return function(g, h, i, j) {
                ...
                (function() {
                    ...
                    a = b.objectWithFields({
                        ...
                        blacklisted_keys_v2: b.allowNull(b.mapOf(b.mapOf(b.mapOf(b.number()))))
                    });
                    k.exports = a
                })();
                return k.exports
                ...
                (function() {
                    ...
                    function oa(a, b) {
                        ...
                        C(b, function(a) {
                            return C(G(a), function(b) {
                                if (c.containsKey(b)) {
                                    if (!ga.has(b)) throw new Error("Custom parameter " + b + " has already been specified.")
                                } else c.append(b, a[b])
                            })
                        });
                        c.append("it", O);
                    ...
                    function $(a) {
                        ...
                        if (c != null) {
                            ...
                            c = c.event_id;
                            f = f != null ? f : c;
                            e.containsKey("eid") ? e.replaceEntry("eid", f) : e.append("eid", f)
                        }
                    ...
                    function ta(a) {
                        a.instance = V, a.callMethod = X, a._initHandlers = [], a._initsDone = {}, a.send = na, a.getEventCustomParameters = oa, a.addInitHandler = ra, a.getState = sa, a.init = Y, a.set = ia, a.loadPlugin = function(a) {
